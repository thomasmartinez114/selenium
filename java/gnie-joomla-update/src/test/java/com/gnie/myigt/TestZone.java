...
public class TestZone {
	...
	public static void main(String[] args) throws IOException {
			...
			https://gnie.myigt.com/sites/tt/cc/administrator/index.php?option=com_joomlaupdate&view=default&layout=complete
...
//			 String[] command = {"cmd.exe", "/C", "Start", "C:\\AdminFiles\\upload_styling_post_update\\run.cmd"};
//	         Process p =  Runtime.getRuntime().exec(command); 
	         
//	 		ProcessBuilder process = new ProcessBuilder("C:\\AdminFiles\\upload_styling_post_update\\single_style_update.ps1");
//	 		process.start();
//	 		System.out.println("COPYING STYLE CODE OVER TO INSTANCE");
		
//		String cmd = "powershell C:\\AdminFiles\\upload_styling_post_update\\single_style_update.ps1";
